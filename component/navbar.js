    ...
    <div id="mwmdiv">
        <div class="men">
            ...
            <div class="dropdown">
                ...
                <a href="" style ="font-size:15px; color:black;">Winterwear</a>
                ...
                <a href="">Trunks</a>
                <a href="" style ="font-size:15px; color:black;">Sports & Activewear</a>
                <a href="">Shirts</a>
                ...
                <a href="">Henleys</a>
                <a href="">Plus Size Bottomwear</a>
                <a href="" style ="font-size:15px; color:black;">Footwear</a>
                <a href="">Plus Size Topwear</a>
                ...
                <a href=""></a>
                <a href=""></a>
                <a href="">Customize T-shirts</a>
                <a href="" style ="font-size:15px; color:black;">Accessories</a>
                <a href="" style ="font-size:15px; color:black;">Plus Size</a>
                <a href="">T-shirt Combos</a>
            </div>
        </div>
        <div class="men">
            <a id="women" href="">WOMEN</a>
                <div class="dropdown">
                    ...
                    <a href="">Joggers</a>
                    <a href="">Half Sleeves T-shirts</a>
                    <a href="">Trousers & Pants</a>
                    <a href=""></a>
                    <a href="">3/4 Sleeve T-Shirts</a>
                    <a href="">Plus Size Bottomwear</a>
                    <a href="" style ="font-size:15px; color:black;">Sports & Activewear</a>
                    <a href="">Tops</a>
                    <a href="">All Bottomwear</a>
                    ...
                    <a href="">Sweaters</a>
                    <a href=""></a>
                    <a href="">Notebooks & Planners</a>
                    <a href="">Customize T-shirts</a>
                    <a href=""></a>
                    <a href="">Mugs</a>
                    <a href="">T-shirts Combos</a>
                    <a href=""></a>
                    <a href=""></a>
                    <a href=""></a>
            </div>
        ...
        <div class="men">
            ...
            <div class="dropdown" style="padding:0px 0px 0px 6px;letter-spacing:0px;">
                ...
                <a href=""></a>
                <a href=""></a>
                <a href="" style="font-size:18px;color:black;margin:10px 0px 10px;">Xiaomi</a>
                <a href="" style="font-size:18px;color:black;margin:10px 0px 10px;">Oneplus</a>
                <a href="" style="font-size:18px;color:black;margin:10px 0px 10px;">Apple</a>
                <a href="">Mi 12 Pro 5G</a>
                <a href="">OnePlus 9R</a>
                <a href="">iPhone 14 Pro Max</a>
                <a href="">Redmi 9 Power</a>
                <a href="">OnePlus 9RT</a>
                <a href="">iPhone 14 Pro</a>
                <a href="">Redmi 10A</a>
                <a href="">OnePlus 9</a>
                <a href="">iPhone 14 Plus</a>
                <a href="" style="font-size:18px;color:black;margin:10px 0px 10px;">Samsung</a>
                <a href="" style="font-size:18px;color:black;margin:10px 0px 10px;">Realme</a>
                <a href="" style="font-size:18px;color:black;margin:10px 0px 10px;">Vivo</a>
                <a href="">Samsung Galaxy Note 10 <br> lite</a>
                <a href="">Realme 5 Pro</a>
                <a href="">Vivo S1</a>
                <a href="">Samsung Galaxy Note 10 <br> Plus</a>
                <a href="">Realme 5</a>
                <a href="">Vivo Y51 2020</a>
                <a href="">Samsung Galaxy Note <br> 10</a>
...
<div id="sldiv">
   <div id="inputdiv"> 
    <div id="searchbar">
        <button style="border:none"><i id="searchicon" class="fa-solid fa-magnifying-glass"></i>
        </button>
        <input id="inputbar" type="text" placeholder="Search by product, collection or category">
    </div>
   </div>
    <div id="logindiv">
...
const footer = () => {
  return `<div id="footerdiv1">
    <div class="insidefooterdiv1">
        <p class="yellowheads">CUSTOMER SERVICE</p>
        <p>Contact us <p>
        <p>Track Order</p>
        <p>Return Order</p>
        <p>Cancel Order</p>  
    ...
    <div class="insidefooterdiv1">
        <p class="yellowheads">CONNECT WITH US</p>
        <p><i class="fa-brands fa-square-facebook"></i> 4.7M People Like this</p>
        <p><i class="fa-brands fa-instagram"></i> 1M Followers</p>
        <p><i class="fa-brands fa-twitter"></i> <i class="fa-brands fa-pinterest"></i> <i class="fa-brands fa-snapchat"></i> <i class="fa-brands fa-apple"></i></p>
    </div>
    <div class="insidefooterdiv1">
        <p class="yellowheads">KEEP UP TO DATE</p>
        <div id="sbtndiv"><input id="email" type="text" placeholder="Enter Email Id"><button id="subscribebtn">SUBSCRIBE</button></div>
    </div>
     
    
</div>
<div id="footerdiv2">
    <div class="insidefooterdiv2">
        <p><i class="fa-solid fa-arrow-rotate-left"></i>  15 Days return policy</p>
        <p><i class="fa-solid fa-coins"></i> Cash on Delivery</p>
    </div>
    <div class="insidefooterdiv2">
        <p class="yellowheads">DOWNLOAD THE APP</p>
        <p><img src="	https://images.bewakoof.com/web/app_android_v1.png" alt=""> <img src="	https://images.bewakoof.com/web/app_ios_v1.png" alt=""></p>
    </div>
    <div class="insidefooterdiv2">
        <p class="yellowheads">100% SECURE PAYMENT</p>
        <P><img src="https://images.bewakoof.com/web/secure-payments-image.png" alt=""></P>
    </div>
</div>
<div id="footerdiv3">
    <div class="insidefooterdiv3">
        <p class="whiteheads">MENS'S CLOTHING</p>
        <p>Top Wear</p>
    ...
    <div class="insidefooterdiv3">
        <p class="whiteheads">WOMEN'S CLOTHING</p>
        ...
        <p>Women's Plus Size Store</p><br>
        <p>Women's Bottom Wear</p>
        <p>Women's Pajamas</p>
        <p>Women's Boxer Shorts</p>
        <p>Women's Jeans</p>
        <p>Women's Joggers</p>
        <p>Women's Shorts</p><br>
        <p>BAGS</p>
        <p>Laptop Bags</p>
        <p>Small Backpacks</p><br>
        <p>Featured</p>
        <p>Women's Slides</p>
        <p>Women's Flip Flops</p>
    </div>
    <div class="insidefooterdiv3">
        <p class="whiteheads">MOBILE COVERS</p>
        <p>Brands</p>
        <p>Apple</p>
        <p>Realme</p>
        <p>Samsung</p>
    ...
    <div class="insidefooterdiv3">
        <p class="blueheads">FANBOOK</p>
        <p class="blueheads">OFFERS</p>
        <p class="blueheads">SITEMAP</p>
    </div>
</div>
<div id="footerdiv4">
    
    <p class="footerheadings">LYNC CLUB THE NEW AGE ONLINE SHOPPING EXPERIENCE.</p>
    ...
    <p class="footerheadings">ONLINE SHOPPING AT BEWAKOOF IS HASSLE-FREE, CONVENIENT AND SUPER-EXCITING!</p>
    ...
    <p class="footerheadings">BEWAKOOF.COM: THE QUIRKIEST ONLINE SHOPPING SITES OF ALL!</p>
    ...
    <p class="footerheadings">AVAIL OF ONLINE SHOPPING BENEFITS AT BEWAKOOF.COM AND YOULL SHOP NOWHERE ELSE!</p>
    ...
    <p class="footerheadings">DONT MISS OUT ON ACCESSORIES AVAILABLE ON OUR MULTI-FACETED ONLINE STORE!</p>
    ...
    <p class="footerheadings">DESIGN OF THE DAY- THE COOLEST FEATURE EVER!</p>
    ...
    <p class="footerheadings">BEWAKOOF.COM: THE UBER COOL ONLINE FASHION STORE FOR THE YOUTH</p>
    ...
    <p class="footerheadings">OUR PHILOSOPHY</p>
